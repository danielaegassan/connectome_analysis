...
save_fn = 'SSCx_model_params_order-2_midrange.h5'

# logging.getLogger().setLevel(logging.WARNING) # Global control of logging level (default: INFO; WARNING to disable outputs)

model_params_2 = []
config_dict = {'bin_size_um': 20, 'max_range_um': 400, 'sample_size': None, 'sample_seeds': num_samples, 'coord_names': ['ss_mapping_x', 'ss_mapping_y']}
