# Description: Running SSCx model building from batch script (local connectivity; per PRE pathway)
# Author: C. Pokorny
...
# Set paths
nrn_path_pre = './modelling/nrn_tables/local'
nrn_fn_pre = 'nrn_info'
nrn_path_post = '/gpfs/bbp.cscs.ch/project/proj102/scratch/SSCX_BioM/matrices'
nrn_fn_post = 'neuron_info'
adj_path = './modelling/adj_matrices/local'
adj_fn = 'adj_mat'
...
if __name__ == "__main__":
    if len(sys.argv) >= 2:
        ...
        print('////////////////////////////////////////////////////////////////////////////////////////////////////')
        print(f'INFO: Running 2nd-order model building of local connectivity ({sample_size} samples, {midx_start}: {mtypes[midx_start]} to {midx_end}: {mtypes[midx_end]})')
        print('////////////////////////////////////////////////////////////////////////////////////////////////////')
        ...
        config_dict = {'bin_size_um': 50, 'max_range_um': 1000, 'sample_size': sample_size, 'sample_seeds': num_samples}

        save_path = f'./modelling/tables_per_pathway_{sample_size}'
        if not os.path.exists(save_path):
            os.makedirs(save_path)
        save_fn = 'SSCx_model_params_order-2_local'
        ...
        print('Runs 2nd-order model extraction of local connectivity per PRE-pathway')
        print('Usage: Provide sample size, and optionally, start and end idx of m-type')
        print('       run_SSCx_model_building_order2_local_per_pathway SAMPLE_SIZE <MTYPE_IDX_START> <MTYPE_IDX_END>')